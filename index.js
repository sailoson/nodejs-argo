...
const UUID = process.env.UUID || 'f63e61d2-0667-4e4b-84aa-0530de0fdfee'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const DOMAIN = process.env.DOMAIN || 'miget1.888169.xyz';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
